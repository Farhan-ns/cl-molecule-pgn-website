 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function success($data, $httpCode = 200, $message = '')
        {
                        return \Illuminate\Routing\ResponseFactory::success($data, $httpCode, $message);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function error($error, $httpCode, $message = '')
        {
                        return \Illuminate\Routing\ResponseFactory::error($error, $httpCode, $message);
        }
